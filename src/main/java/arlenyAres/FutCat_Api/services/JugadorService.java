...
import arlenyAres.FutCat_Api.repositories.JugadorRepository;
...
public class JugadorService {
    ...
    @Transactional
    public boolean registrarJugador(String nombre, String apellido, String tipoDocumento, String numDocumento,
                                    int numCamiseta, String posicion, Equipo equipo) {
        ...
        nuevoJugador.setEquipo((arlenyAres.FutCat_Api.models.Equipo) equipo);
    ...
    @Transactional
    public boolean actualizarJugador(Integer idJugador, String nuevoNombre, String nuevoApellido,
                                     int nuevoNumCamiseta, String nuevaPosicion) {
