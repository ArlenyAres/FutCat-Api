...
public interface JugadorRepository extends JpaRepository<Jugador, Integer> {
    ...
    Jugador findByNombreAndApellidoAndEquipoId(@Param("nombre") String nombre,
    ...
    Jugador findByNumCamisetaAndEquipoId(@Param("numCamiseta") int numCamiseta,
                                         @Param("idEquipo") Integer idEquipo);
    ...
    void actualizarJugador(@Param("idJugador") Integer idJugador,
                           @Param("nuevoNombre") String nuevoNombre,
                           @Param("nuevoApellido") String nuevoApellido,
                           @Param("nuevoNumCamiseta") int nuevoNumCamiseta,
